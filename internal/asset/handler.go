...
// HandleAdminUpdateDirect processa PATCH /api/v1/admin/assets/{id}.
func (h *Handler) HandleAdminUpdateDirect(w http.ResponseWriter, r *http.Request) {
	...
	a, err := h.svc.AdminUpdateDirect(r.Context(), id, req)
	if err != nil {
		response.HandleError(w, r, err)
		return
	}
...
// HandleAdminHardDelete processa DELETE /api/v1/admin/assets/{id}.
