...
// Handler expõe os endpoints HTTP de monitoramentos.
type Handler struct {
	svc *Service
}

// NewHandler cria o handler de monitoramentos.
func NewHandler(svc *Service) *Handler {
	return &Handler{svc: svc}
}

// HandleList processa GET /api/v1/assets/{asset_id}/monitoramentos.
...
// HandleGet processa GET /api/v1/monitoramentos/{id}.
...
// HandleCreate processa POST /api/v1/monitoramentos.
...
// HandleUpdate processa PATCH /api/v1/monitoramentos/{id}.
...
// HandleDelete processa DELETE /api/v1/monitoramentos/{id}. Soft delete.
...
// HandleSubmit processa POST /api/v1/monitoramentos/{id}/submit.
...
// HandleApprove processa POST /api/v1/monitoramentos/{id}/approve.
...
// HandleReject processa POST /api/v1/monitoramentos/{id}/reject.
